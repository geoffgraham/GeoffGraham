...
<!--[if IE ]>
	...
	<?php if (true == of_get_option('meta_google_plus')) {
	  echo '<link rel="author" href="'.of_get_option("meta_google_plus").'" />';
	} ?>
    ...
    <script type="text/javascript">
        (function() {
          var config = {
            <?php if (true == of_get_option('meta_typekit_id')) {
              echo 'kitId: "'.of_get_option("meta_typekit_id").'",';
            } ?>
...
<header role="header" class="main" role="banner">
  ...
  <nav class="social" role="social">
    <ul>
      <li>
        <a alt="Follow Geoff Graham on Twitter" href="http://twitter.com/geoffreygraham" aria-hidden="true" data-icon="&#xe000;" onClick="ga('send', 'event', 'Social', 'Click', 'Twitter', 1);"></a>
      </li>
      <li>
        <a alt="See Geoff Graham on LinkedIn" href="http://www.linkedin.com/in/geoffreyjgraham" aria-hidden="true" data-icon="&#xe001;" onClick="ga('send', 'event', 'Social', 'Click', 'LinkedIn', 1);"></a>
      </li>
      <li>
        <a alt="Check out Geoff Graham on Codepen" href="https://codepen.io/geoffgraham" aria-hidden="true" data-icon="&#xe002;" onClick="ga('send', 'event', 'Social', 'Click', 'CodePen', 1);"></a>
      </li>
      <li>
        <a alt="Subscribe to Geoff Graham Blog RSS" href="<?php bloginfo('rss_url'); ?>" aria-hidden="true" data-icon="&#xe004;" onClick="ga('send', 'event', 'Social', 'Click', 'RSS', 1);"></a>
      </li>
    </ul>
  </nav><!-- social -->
</header>
